                    ...
                    <form className="space-y-4 " >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-col space-y-2">
                          ...
                          <button className="p-3 border rounded-md flex items-center space-x-2 bg-blue-100">
                          <FaRegUser /><span>I'm a solo creator</span>
                          </button>
                          <button className="p-3 border rounded-md flex items-center space-x-2">
                          <FaUserGroup /><span>I'm part of a team</span>
                          </button>
                        </div>
                      </div>
